describe("ListView", () => {
  describe("#convert", function() {
    ...
    expect.isEqual(
      ...
      listView.converted,
      "<ul><li><div><a href='#notes/0'>hello</a></div></li><li><div><a href='#notes/1'>goodbye</a></div></li></ul>"
    );
    ...
    expect.isEqual(
      ...
      listView.converted,
      "<ul><li><div><a href='#notes/0'>hello wow its very n</a></div></li><li><div><a href='#notes/1'>this is a note of so</a></div></li></ul>"
    );
  });
